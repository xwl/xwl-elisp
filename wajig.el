...
;; Version: v 0.5
;; Last updated: 2006/09/04 22:45:36
...
\\{wajig-mode-map}"
  ...
  (if (file-readable-p wajig-cache-filename)
    ...
    (setq wajig-installed-pkgs (wajig-update-installed-pkgs)
          wajig-command-path-alist (wajig-update-command-path-alist)
          wajig-daemons (wajig-update-daemons))
    (with-temp-buffer
